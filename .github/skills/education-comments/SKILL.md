...
description: 'Use when adding educational inline comments to code files, turning code into a learning resource, or when the user asks for didactic code annotations.'
---
